        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12">
          ...
          <div className="text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-2">
              ...
              <span className="text-xl font-bold text-white tracking-tight">Born2WinPh</span>
            </div>
            <p className="mt-4 text-sm text-gray-400 max-w-xs mx-auto lg:mx-0">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
            ...
            <Link href="/free-webinar" className="text-sm text-gray-400 hover:text-white transition-colors">Free Webinar</Link>
